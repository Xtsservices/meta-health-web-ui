...
export default function BasicTable() {
  ...
  const getRecentDataApi = useRef(true);
  ...
  }, [user.hospitalID, user.id, user.role, user.token]);
  ...
  async function handlePatientView(id: number | null) {
    ...
    if (response.message == "success") {
      return navigate(`/hospital-dashboard/triage/list/${id}`);
    }
  }
