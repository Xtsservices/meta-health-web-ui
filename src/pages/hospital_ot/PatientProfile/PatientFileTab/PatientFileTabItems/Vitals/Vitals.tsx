...
function Vitals() {
  ...
  const getAllVitals = useCallback(async () => {
  ...
  }, [setVitals, timeline.patientID, user.hospitalID, user.token]);

  React.useEffect(() => {
    if ((user.token, timeline.id)) {
      getAllVitals();
    }
  }, [user, timeline, getAllVitals]);
  ...
  return (
    <div className={styles.container}>
      <div className={styles.info_header}>
        {/* Ability to add vitals not available as patient file is read only  */}
