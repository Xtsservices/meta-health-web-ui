...
export default function TransferPatientDialog({ open, setOpen }: propType) {
  ...
  const [patientType] = React.useState<number | null>(null); ////To set whether patient wants to be transffered to outpatient or inpatient
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const reqObj = {
      ...
      reason: formData.reason.value || null,
              ...
              <Grid item xs={12}>
                ...
                >
                  ...
                  <Select
                    ...
                    value={
                      formData.wardID.value ? String(formData.wardID.value) : ""
                    }
                    label="Ward"
                    ...
                    required
                  >
                    {wardList.some((ward) => ward.availableBeds !== null) ? (
                      wardList.map((ward) => (
                        <MenuItem
                          key={ward.id}
                          value={ward.id}
