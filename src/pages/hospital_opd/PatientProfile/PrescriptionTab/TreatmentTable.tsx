...
import AddedBy from "../../../../component/DailogBoxs/AddedBy";
...
const DataTable: React.FC<DataTableProps> = ({ prescriptionData }) => {
    ...
    if (Array.isArray(prescriptionData)) {
      setRows(
        prescriptionData.map((medicineData) => ({
          ...
          medicineDuration: medicineData.medicineDuration !== null ? Number(medicineData.medicineDuration) : null,
          ...
          status: medicineData.status === 1 ? "Active" : "Inactive",
        }))
      );
  ...
  const columns: GridColDef[] = [
    ...
    { field: "medicineStartDate", headerName: "Medicine StartDate", width: 170 },
