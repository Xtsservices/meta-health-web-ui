  ...
  const handleTextChange = (
    ...
    if (name === "age") {
      ...
      if (!inputValue) {
        ...
        } else if (category == "neonate" && inputValue > 4) {
          message = "Weight should be under 4 kgs";
          isvalid = false;
        }
      }
    }
      ...
      if (!inputValue) {
        ...
        } else if (category == "neonate" && inputValue > 55) {
          message = "Height should be under 55 cms";
        }
      }
    }
    ...
    <Grid container columnSpacing={2} rowSpacing={4}>
      ...
      <Grid item xs={6}>
        <FormControl variant="outlined" fullWidth required>
          ...
          >
            {state.map((name) => {
              // console.log(formData.state.value);
