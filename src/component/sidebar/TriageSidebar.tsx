      ...
      <div className={styles.sidebar}>
        <div className={styles.sidebar_container}>
          <div className={styles.sidebar_container_box}>
            ...
            >
              <img src={yantramLogo} alt="yantram" className="" />
            </div>
            ...
            <Button
              linkName={"/hospital-dashboard/triage"}
              name={"Dashboard"}
              iconDark={dashboardDark}
              iconLight={dashboard}
              exact={true}
              setSearch={setSearch}
              bgColor={styles.triage_active}
            />
            <Button
              linkName={"/hospital-dashboard/triage/list"}
              name={"Patients List"}
              iconDark={inpatient}
            ...
            />
            <Button
              linkName={"/hospital-dashboard/triage/addpatient"}
              name={"Add Patient"}
            ...
            />
            <Button
              linkName={"/hospital-dashboard/triage/Managment"}
              name={"Managment"}
            ...
            <Button
              linkName={"/hospital-dashboard/triage/help"}
              name={"Help"}
              iconDark={help_icon}
        ...
        <div className={styles.main}>
          <div className={styles.topbar}>
            ...
            <PopperMenu
              setOpen={setOpenMenu}
              open={openMenu}
              url={"/hospital-dashboard/triage/profile"}
              anchorRef={anchorRef}
              color="#ffced6"
            />
          </div>
