      ...
      <div className={styles.sidebar}>
        <div className={styles.sidebar_container}>
          <div className={styles.sidebar_container_box}>
            ...
            <Button
              linkName={"/hospital-dashboard/opd"}
              name={"Dashboard"}
              iconDark={dashboardDark}
              iconLight={dashboard}
              exact={true}
              setSearch={setSearch}
              bgColor={styles.opd_active}
            />
            <Button
              linkName={"/hospital-dashboard/opd/addpatient"}
              name={"Add Patient"}
            ...
            />
            <Button
              linkName={"/hospital-dashboard/opd/previouspatients"}
              name={"Patients List"}
              iconDark={inpatient}
            ...
            />
            <Button
              linkName={"/hospital-dashboard/opd/Managment"}
              name={"Managment"}
            ...
            <Button
              linkName={"/hospital-dashboard/opd/help"}
              name={"Help"}
              iconDark={help_icon}
        ...
        <div className={styles.main}>
          <div className={styles.topbar}>
            ...
            <PopperMenu
              setOpen={setOpenMenu}
              open={openMenu}
              url={"/hospital-dashboard/opd/profile"}
              anchorRef={anchorRef}
              color="#f9b995"
            />
          </div>
