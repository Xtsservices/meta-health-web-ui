...
import SearchPatientEmergencyRed from "../Searchpatient/SearchPatientEmergencyRed";
      ...
      <div className={styles.sidebar}>
        <div className={styles.sidebar_container}>
          <div className={styles.sidebar_container_box}>
            ...
            <Button
              linkName={"/hospital-dashboard/emergency-red"}
              name={"Dashboard"}
              iconDark={dashboardDark}
              iconLight={dashboard}
              exact={true}
              setSearch={setSearch}
              bgColor={styles.red_active}
            />
            <Button
              linkName={"/hospital-dashboard/emergency-red/list"}
            ...
            />
            <Button
              linkName={"/hospital-dashboard/emergency-red/dischargepatient"}
            ...
            />
            <Button
              linkName={"/hospital-dashboard/emergency-red/Managment"}
              name={"Managment"}
            ...
            <Button
              linkName={"/hospital-dashboard/emergency-red/help"}
              name={"Help"}
              iconDark={help_icon}
        ...
        <div className={styles.main}>
          <div className={styles.topbar}>
            ...
            <PopperMenu
              setOpen={setOpenMenu}
              open={openMenu}
              url={"/hospital-dashboard/emergency-red/profile"}
              anchorRef={anchorRef}
              color="#f99f99"
            />
          </div>
              ...
              {!search ? (
                ...
                <div className={styles.search_container}>
                  <div className={styles.search_container_card}>
                    <SearchPatientEmergencyRed search={search} />
                  </div>
                </div>
              )}
            </div>
...
export default EmergencyRedSidebar;
