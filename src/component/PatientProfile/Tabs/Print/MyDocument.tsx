  ...
  return (
    <Document>
      <Page size="A4">
        ...
        {data.medicalHistory ? (
          <Summary medicalHistory={data.medicalHistory} />
        ) : (
          ""
        )}
        {data?.reports?.map((report, index) => {
          if (
            ...
            (report.mimeType.endsWith("png") || report.mimeType.endsWith("jpg"))
          )
            <Page size="A4">
              <Image src={report.fileURL} key={index} style={styles.image} />
            </Page>;
          else return <></>;
        })}
      </Page>
