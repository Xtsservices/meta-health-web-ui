import Capsule_icon_svg from "../../../../assets/PatientProfile/capsule_icon_svg";
  ...
  return (
    ...
    >
      ...
      {medicineCategory.tablets == medicineType ? (
       ...
       {medicineCategory.Drops == medicineType ? (
        <Drop_svg fill="white" rect="transparent" />
      ) : (
        ""
      )}
       {medicineCategory.Spray == medicineType ? (
        <Spray_svg fill="white" rect="transparent" />
      ) : (
        ""
      )}
       {medicineCategory.Topical == medicineType ? (
        <Topical_svg fill="white" rect="transparent" />
      ) : (
        ""
      )}
       {medicineCategory.Tubing == medicineType ? (
        <Tube_svg fill="white" rect="transparent" />
      ) : (
        ""
      )}
    </p>
