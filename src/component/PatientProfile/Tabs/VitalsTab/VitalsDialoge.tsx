...
type formDialogType = {
  ...
  unit: string;
  showID: number | null;
  vitals?: vitalsType[] | undefined; // Optional vitals prop for homecarepatient
};
    ...
    <div>
      ...
      >
        ...
        <DialogContent dividers>
          {option == "logs" && <Logs category={category} unit={unit} vitals={vitals} showID={showID} />}
          {option == "chart" && <LineChart category={category} unit={unit} vitals={vitals} />}
        </DialogContent>
      </BootstrapDialog>
    </div>
  );
